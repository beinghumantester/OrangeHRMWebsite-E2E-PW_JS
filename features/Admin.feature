Feature: Add , Edit & Delete Employee on Admin Dashboard
   Scenario: Navigate to Admin Dashboard 
   Given User successfully login and landed on dashboard
   When User search Admin in search bar and click on Admin in suggestions
   Then User landed on the Admin Dashboard 


   Scenario: New user can be successfully added
   Given User click on the Add button on the Admin Dashboard 
